...
public class MyEventAdapter extends RecyclerView.Adapter<MyEventAdapter.EventHolder> {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        public TextView nameView, datumView, townView, dayTextView;
    ...
    public MyEventAdapter(List<Event> moviesList, Context context) {
    ...
    public EventHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_my_event_row, parent, false);
    ...
    public void onBindViewHolder(EventHolder holder, int position) {
        ...
        if (c3.get(Calendar.YEAR) == c0.get(Calendar.YEAR)
            ...
            holder.dayTextView.setText("Vorbei");
            holder.rootLayout.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.colorAccentCloudy, null));
        }
